...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Gojo Hub chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Gojo Hub", HidePremium = false, IntroText = "Gojo Hub⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("Gojo Hub SCRIPT")
W:AddLabel("DiscordGojo Hub")
local Section = W:AddSection({
    Name = "Status"
})
